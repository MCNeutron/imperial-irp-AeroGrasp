...
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage1_long_full_hm3d_1-2_libero_spatial/step_best" # From AGVLA (parallel action head) stage 1 long training, on full hm3d_1-2 and LIBERO Spatial (on A40)
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage2_PCGrad_full_hm3d_1-2_libero_spatial_correct_loss_split/step_best" # From AGVLA (parallel action head) PCGrad (with correct loss split) stage 2 training, on full hm3d_1-2 and LIBERO Spatial (on A40)
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage2_PCGrad_full_hm3d_1-2_libero_spatial_dsapi/step_best" # From AGVLA (parallel action head) PCGrad (with DeepSpeed APIs) stage 2 training, on full hm3d_1-2 and LIBERO Spatial (on A40)
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage2_PCGrad_full_hm3d_1-2_libero_spatial_dsapi/step_10000" # From AGVLA (parallel action head) PCGrad (with DeepSpeed APIs) stage 2 training, on full hm3d_1-2 and LIBERO Spatial (on A40)
...
### NEW CHECKPOINTS, with orientation-dependent rel states and actions ###
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage1_hm3d_4_single_traj_test/step_best" # Training on only hm3d_4, stage 1
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage2_hm3d_4_single_traj_test/step_best" # Training on only hm3d_4, stage 2
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage2_hm3d_2_4_traj_test/step_best" # Training on only hm3d_2 + 4, stage 2
...
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage2_resume_diff_heads_body_rel_PCGrad_full_hm3d_1-6_libero_1-3_dsapi_task_split/step_best" # From AGVLA (parallel action head), diff action head depth, body relative states and actions, PCGrad (with DeepSpeed APIs, per task normalisation loss splits) stage 2 resume training, on full hm3d_1-6 and LIBERO Spatial, Object and Goal (on A40)
# CKPT_DIR = "/rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_combined/stage2_resume6_diff_heads_body_rel_PCGrad_full_hm3d_1-6_libero_1-3_dsapi_task_split/step_best" # From AGVLA (parallel action head), diff action head depth, body relative states and actions, PCGrad (with DeepSpeed APIs, per task normalisation loss splits) stage 2 resume 6 training, on full hm3d_1-6 and LIBERO Spatial, Object and Goal (on A40)
