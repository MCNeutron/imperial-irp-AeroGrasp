#!/bin/bash
#PBS -N agvla_habitatsim_stage1_10_horizon_train
...
--per_action_dim 24 \
--state_dim 24 \
--save_dir /rds/general/user/ll1225/ephemeral/imperial_irp/extended_evo1/checkpoints/agvla_habitatsim/stage1_10_horizon
