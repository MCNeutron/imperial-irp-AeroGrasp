...
(
    ...
    cd /rds/general/user/ll1225/home/imperial_irp/extended_evo1/AeroGraspVLA # Go to scripts dir

    python agvla_server.py # Run the agvla_server script
    echo "SERVER EXIT CODE: $?"
) > debug/agvla_server.log 2>&1 &

SERVER_PID=$! # Track AGVLA server PID
