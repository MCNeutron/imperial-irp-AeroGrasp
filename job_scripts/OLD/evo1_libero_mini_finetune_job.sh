#!/bin/bash
#PBS -N evo1_libero_mini_finetune
...
--resume \
--resume_path /rds/general/user/ll1225/home/imperial_irp/extended_evo1/weights/evo1_libero_test_weights
