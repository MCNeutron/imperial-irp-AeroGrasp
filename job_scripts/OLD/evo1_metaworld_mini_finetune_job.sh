#!/bin/bash
#PBS -N evo1_metaworld_mini_finetune
...
echo "CUDA_VISIBLE_DEVICES after setting=$CUDA_VISIBLE_DEVICES"
...
scripts/train.py \
--run_name Evo1_metaworld_mini_finetune \
...
--per_action_dim 24 \
--state_dim 24 \
--save_dir /rds/general/user/ll1225/home/imperial_irp/extended_evo1/checkpoints/mini_finetune \
--resume \
--resume_path /rds/general/user/ll1225/home/imperial_irp/extended_evo1/weights/evo1_metaworld_test_weights
