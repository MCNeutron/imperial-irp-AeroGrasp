#!/bin/bash
#PBS -N evo1_libero_stage1_train
...
--run_name Evo1_libero_stage1_train \
...
--per_action_dim 24 \
--state_dim 24 \
--save_dir /rds/general/user/ll1225/home/imperial_irp/extended_evo1/checkpoints/hpc_retrain/libero/stage1
