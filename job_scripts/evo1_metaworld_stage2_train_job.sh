#!/bin/bash
#PBS -N evo1_metaworld_stage2_train
...
scripts/train.py \
--run_name Evo1_metaworld_stage2_train \
...
--per_action_dim 24 \
--state_dim 24 \
--save_dir /rds/general/user/ll1225/home/imperial_irp/extended_evo1/checkpoints/hpc_retrain/stage2 \
--resume \
--resume_pretrain \
--resume_path /rds/general/user/ll1225/home/imperial_irp/extended_evo1/checkpoints/hpc_retrain/stage1/step_best
